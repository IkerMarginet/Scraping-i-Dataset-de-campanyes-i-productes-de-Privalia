...
def main():
    ...
    # Menú interactiu per a imatges de depuració (debug)
    ...
    if save_debug:
        ...
        print(" -> Mode depuració INACTIU. No es guardaran imatges (més net i ràpid).")

    crawler = PrivaliaCrawler()

    # Netejar fitxer de productes anterior per començar de zero en aquesta sessió
    ...
    try:
        ...
        # Guardar totes les campanyes descobertes d'un cop
        campaigns_data = []
        ...
        for camp_index, camp in enumerate(campaigns_to_visit, start=1):
            ...
            for prod_index, product in enumerate(base_products_to_visit, start=1):
                ...
                # Guardar el producte IMMEDIATAMENT (Incremental)
                product_item = {
